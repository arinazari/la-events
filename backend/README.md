...
| `GITHUB_TOKEN`      | `wrangler secret put` | optional — a **fine-grained PAT scoped to this repo, Contents: read & write**. Set it to enable taste **and** profile self-edit; leave it unset and the Worker is chat-only. |
